    ...
    return (
      <div className="mt-3 p-4 rounded-lg border-l-4 border-teal-500 bg-teal-50">
        ...
        <p className="text-xs text-gray-400 italic mt-2">
          Ceci n&rsquo;est pas un diagnostic médical.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-3">
      {!resultat ? (
        ...
        <div
          className={`p-4 rounded-lg border-l-4 ${couleurs[resultat.urgence as keyof typeof couleurs] || couleurs.moyen}`}
        >
          ...
          <p className="text-xs text-gray-400 italic mt-3">
            Ceci n&rsquo;est pas un diagnostic médical. Consultez un
